...
def wav2lip_run(adir):
  ...
  command = f'python inference.py --checkpoint_path /home/ec2-user/extras/LIHQ/Wav2Lip/checkpoints/wav2lip.pth --face {vid_path} --audio {aud_path} --outfile {out_path}  --pads 0 20 0 0'
  try:
