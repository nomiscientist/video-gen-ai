...
def generate(config, validationloader, model, revtrans,testset):
...
def test(config, validationloader, model, revtrans, testset):
    ...
    generate(config, validationloader, model, revtrans, testset)
...
def main(config):
  ...
  print(testset)
  test(config, validationloader, model, revtrans,testset)
